package edu.ucsb.cs56.w15.drawings.parsahadidi.simple;
...
/**
   ...
   @author Parsa Hadidi (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Parsa Hadidi", 20,40);
    }
