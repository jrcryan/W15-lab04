package edu.ucsb.cs56.w15.drawings.ecarnohan.simple;
...
/**
   ...
   @author Erica Carnohan (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Erica Carnohan", 20,40);
    }
