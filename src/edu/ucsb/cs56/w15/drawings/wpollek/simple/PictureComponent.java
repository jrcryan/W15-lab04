package edu.ucsb.cs56.w15.drawings.wpollek.simple;
...
/**
   A component that draws a Picture by Phill Conrad, With fixes by Wesley Pollek
   
   @author Phill Conrad (original drawing)
   @author Wesley Pollek (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManTopCircle = 
       ...
       g2.drawString("Top of snowman added by Wesley Pollek", 20,40);
    }
