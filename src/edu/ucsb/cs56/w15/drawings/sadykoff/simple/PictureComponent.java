package edu.ucsb.cs56.w15.drawings.sadykoff.simple;
...
/**
   ...
   @author Boris Sadykoff (fixed the snowmans's head)
...
{  
   ...
   {  
	  ...
	  (
       ...
       g2.drawString("Top of snowman added by Boris Sadykoff", 20,40);
    }
