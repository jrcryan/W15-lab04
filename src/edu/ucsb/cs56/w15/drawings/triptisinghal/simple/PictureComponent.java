package edu.ucsb.cs56.w15.drawings.triptisinghal.simple;
...
/**
   ...
   @author Tripti Singhal (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Tripti Singhal", 20,40);
    }
