package edu.ucsb.cs56.w15.drawings.jdogg5566;
import javax.swing.*;
...
public class SimpleGui1 {
    ...
    */
	...
	JButton button = new JButton("click me you hairy beast") ;
	frame. setDefaultCloseOperation(JFrame. EXIT_ON_CLOSE) ;
	frame. getContentPane() . add(button) ;
	frame. setSize(300,300) ;
	frame. setVisible(true) ;
    java.awt.Color myColor = new java.awt.Color(0,225, 225);   // R, G, B values.
