...
/** A viewer class for DDR components
 *  drawn with Rectangle2D.double and
 *  general path lines.
 *  
...
public class MultiPictureViewer
{
   public static void main(String[] args)
   {
       ...
       frame.setSize(960,600); // @@@ MODIFY THIS LINE IF YOU LIKE
       
       // Set your own title
       frame.setTitle("Shayan's First Drawing"); // @@@ MODIFY THIS LINE
