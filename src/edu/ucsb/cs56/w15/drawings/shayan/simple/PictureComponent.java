package edu.ucsb.cs56.w15.drawings.shayan.simple;
...
/**
   ...
   @author Shayan Sadigh (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManTopCircle = 
       ...
       g2.drawString("Top of snowman added by Shayan Sadigh", 20,40);
    }
